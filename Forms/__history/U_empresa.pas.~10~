...
//inseri foto
Q_padrao.Edit;
OpenDialog1.Execute;//EXECUTA
dbimage1.Picture.LoadFromFile(OpenDialog1.FileName);//RECEBE A IMAGEM SELECONADA
q_padrao.Refresh;  // ATUALIZA A MESAGEM
MessageDlg ('imagem inserida com sucesso',mtinformation,[mbok], 0);//MANDA A MESAGEM
...
begin
  inherited;
q_padrao.FieldByName('CADASTRO').AsDateTime := Now;
DB_RAZAO_SOCIAL.SetFocus;
end;

procedure TFrm_empresa.DB_CADASTROChange(Sender: TObject);
begin
  inherited;
